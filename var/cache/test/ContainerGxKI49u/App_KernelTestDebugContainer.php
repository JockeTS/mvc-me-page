...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\VizController' => 'getVizControllerService',
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RC9at-Qjo7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7jFfd1q-vL', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G0QsKenaB+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IktPcbVHYr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AURK8KMV-I', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5CfDrmfV0U', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fCrKYEMvXt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vrvxNoGXLX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.webpack_encore.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Oruv+NJU5I', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
     ...
     */
    protected function getChartjs_TwigExtensionService()
    {
        $a = ($this->privates['stimulus.helper'] ?? $this->getStimulus_HelperService());

        if (isset($this->privates['chartjs.twig_extension'])) {
            return $this->privates['chartjs.twig_extension'];
        }

        return $this->privates['chartjs.twig_extension'] = new \Symfony\UX\Chartjs\Twig\ChartExtension($a);
    }
    ...
    protected function getDoctrine_Orm_ContainerRepositoryFactoryService()
    {
        return $this->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\DataPointRepository' => ['privates', 'App\\Repository\\DataPointRepository', 'getDataPointRepositoryService', true],
            'App\\Repository\\IndicatorRepository' => ['privates', 'App\\Repository\\IndicatorRepository', 'getIndicatorRepositoryService', true],
        ], [
            'App\\Repository\\BookRepository' => '?',
            'App\\Repository\\DataPointRepository' => '?',
     ...
     */
    protected function getStimulus_TwigExtensionService()
    {
        $a = ($this->privates['stimulus.helper'] ?? $this->getStimulus_HelperService());

        if (isset($this->privates['stimulus.twig_extension'])) {
            return $this->privates['stimulus.twig_extension'];
        }

        return $this->privates['stimulus.twig_extension'] = new \Symfony\UX\StimulusBundle\Twig\StimulusTwigExtension($a);
    }
     ...
     */
    protected function getStimulus_UxControllersTwigExtensionService()
    {
        return $this->privates['stimulus.ux_controllers_twig_extension'] = new \Symfony\UX\StimulusBundle\Twig\UxControllersTwigExtension();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(($this->privates['stimulus.ux_controllers_twig_extension'] ?? ($this->privates['stimulus.ux_controllers_twig_extension'] = new \Symfony\UX\StimulusBundle\Twig\UxControllersTwigExtension())));
        $instance->addExtension(($this->privates['chartjs.twig_extension'] ?? $this->getChartjs_TwigExtensionService()));
        $instance->addExtension(($this->privates['stimulus.twig_extension'] ?? $this->getStimulus_TwigExtensionService()));
