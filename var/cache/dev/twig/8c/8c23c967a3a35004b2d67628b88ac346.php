...
/* base.html.twig */
class __TwigTemplate_b8fa825cb2f3e81afd4b941a12db601b extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body>
        ...
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/clouds.jpeg"), "html", null, true);
        echo ")\">
            <span class=\"site-title\">Jocke's MVC</span>
        </header>
        ...
        echo "\">Game</a>
            <a href=\"";
        // line 31
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("library_start");
        echo "\">Library</a>
            <a href=\"";
        // line 32
...
";
    ...
    {
        return array (  214 => 38,  201 => 14,  191 => 13,  178 => 10,  168 => 9,  149 => 5,  132 => 39,  130 => 38,  123 => 34,  119 => 33,  115 => 32,  111 => 31,  107 => 30,  103 => 29,  99 => 28,  95 => 27,  91 => 26,  87 => 25,  83 => 24,  75 => 19,  70 => 16,  68 => 13,  65 => 12,  62 => 9,  57 => 6,  53 => 5,  47 => 1,);
    }
...
<html>
    ...
    <body>
        <header class=\"site-header\" style=\"background-image: url({{ asset('img/clouds.jpeg') }})\">
            <span class=\"site-title\">Jocke's MVC</span>
        </header>
        ...
        <nav>
            ...
            <a href=\"{{ path('library_start') }}\">Library</a>
            <a href=\"{{ path('api_start') }}\">API</a>
            <a href=\"{{ path('metrics') }}\">Metrics</a>
            <a href=\"{{ path('viz_start') }}\">Projekt</a>
        </nav>
...
", "base.html.twig", "/Users/jockesjolin/dbwebb-kurser/mvc/me/report/templates/base.html.twig");
    }
}
