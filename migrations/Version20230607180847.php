 ...
 */
final class Version20230607180847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__data_point AS SELECT id, year, value FROM data_point');
        ...
        $this->addSql('INSERT INTO data_point (id, year, value) SELECT id, year, value FROM __temp__data_point');
