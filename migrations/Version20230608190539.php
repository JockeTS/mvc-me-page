 ...
 */
final class Version20230608190539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE data_point (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, indicator_id INTEGER NOT NULL, year VARCHAR(4) NOT NULL, value DOUBLE PRECISION NOT NULL, CONSTRAINT FK_F91A3FBB4402854A FOREIGN KEY (indicator_id) REFERENCES indicator (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
